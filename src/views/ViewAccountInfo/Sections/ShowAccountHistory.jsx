                  ...
                  case 'delegatebw':
                    return (
                      <TableRow key={id} className={classes.tableRow}>
                        ...
                        <TableCell> {p.action_trace.act.data.from}â†’{p.action_trace.act.data.receiver}: {p.action_trace.act.data.stake_cpu_quantity} stakeCpu and {p.action_trace.act.data.stake_net_quantity} stakeNet</TableCell>
                        <TableCell >{""}</TableCell>
                      </TableRow>
                    );
                  case 'claimrewards':
